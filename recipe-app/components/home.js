...
import { Platform, StyleSheet, Text, View, Button, StatusBar, Image, TouchableOpacity } from "react-native";
        ...
        <View style={styles.content}>
          <View style={styles.lastRecipeDisplay}>
            <View style={styles.lastRecipeHeader}>
              <Text style={styles.headingText}>Your Last Recipe</Text>
            </View>
            <View style={styles.lastRecipeFoodDesc}>
              ...
              />
              <Text style={styles.bodyText}>Put Name of Dish Here</Text>
